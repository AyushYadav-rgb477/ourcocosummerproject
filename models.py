...
class NotificationRead(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    notification_type = db.Column(db.String(50), nullable=False)  # 'comment', 'vote', 'collaboration', etc.
    notification_id = db.Column(db.String(100), nullable=False)  # e.g., 'comment_123', 'vote_456'
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    ...
    __table_args__ = (db.UniqueConstraint('user_id', 'notification_id', name='unique_user_notification_read'),)
